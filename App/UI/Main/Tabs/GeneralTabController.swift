                    ...
                    if error == nil {
                        ...
                        enableTimeoutTimer?.setEventHandler(qos: .userInitiated, flags: [], handler: {
                            ...
                            if let window = NSApp.mainWindow {
                                let rawMessage = NSLocalizedString("enable-timeout-toast", comment: "First draft: If you have **problems enabling** the app, click&nbsp;[here](https://github.com/manishshanker/mac-mouse-fix-activated/discussions/861).")
